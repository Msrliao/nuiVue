        ...
        >
            ...
            >
                <n-grid cols="1 s:1 m:2 l:2 xl:2 2xl:2" responsive="screen">
                    <n-form-item-gi  label="客户简称:" path="xm">
                        <n-input v-model:value="formValue.xm" placeholder="请输入配件序码" />
                    </n-form-item-gi >
                    <n-form-item-gi  label="客户简拼:" path="bm">
                        <n-input v-model:value="formValue.bm" placeholder="请输入配件编码" />
                    </n-form-item-gi >
                    <n-form-item-gi  label="客户全称:" path="mc">
                        <n-input v-model:value="formValue.mc" placeholder="请输入配件名称" />
                    </n-form-item-gi >
                    <n-form-item-gi  label="联系人:" path="jc">
                        <n-input v-model:value="formValue.jc" placeholder="请输入配件简拼" />
                    </n-form-item-gi >
                     <n-form-item-gi  label="联系电话:" path="jc">
                        <n-input v-model:value="formValue.jc" placeholder="请输入配件简拼" />
                    </n-form-item-gi >
                     <n-form-item-gi  label="座机电话:" path="jc">
                        <n-input v-model:value="formValue.jc" placeholder="请输入配件简拼" />
                    </n-form-item-gi >
                     <n-form-item-gi  label="其他联系方式:" path="jc">
                        <n-input v-model:value="formValue.jc" placeholder="请输入配件简拼" />
                    </n-form-item-gi >
                     <n-form-item-gi  label="联系地址:" path="jc">
                        <n-input v-model:value="formValue.jc" placeholder="请输入配件简拼" />
                    </n-form-item-gi >
                     <n-form-item-gi  label="联系地址:" path="jc">
                        <n-input v-model:value="formValue.jc" placeholder="请输入配件简拼" />
                    ...
                    <n-form-item-gi  label="联系电话:"  path="cx">
                        <n-select
